...
function getTrayMenuTemplate() {
    return [
        ...
        },
        {
            ...
            label: '矫正计时',
            click: () => {
                win.webContents.send('getTimeOffset', 0); // 默认传递 0 作为初始值
            }
        },
        {
            icon: path.join(basePath, 'image', 'toggle.png'),
            label: '切换日程',
            click: () => {
        ...
        },
        {
            ...
            click: (e) => {
                ...
                if (testGUIWindow) {
                    testGUIWindow.webContents.send('updateCheckbox', { id: 'classCountdown', checked: e.checked });
                }
            }
        },
        {
            ...
            click: (e) => {
                ...
                if (testGUIWindow) {
                    testGUIWindow.webContents.send('updateCheckbox', { id: 'windowAlwaysOnTop', checked: e.checked });
                }
            }
        },
        {
            ...
            click: (e) => {
                ...
                if (testGUIWindow) {
                    testGUIWindow.webContents.send('updateCheckbox', { id: 'classHidden', checked: e.checked });
                }
            }
        },
        {
            ...
            click: (e) => {
                ...
                setAutoLaunch();
                if (testGUIWindow) {
                    testGUIWindow.webContents.send('updateCheckbox', { id: 'autoLaunch', checked: e.checked });
                }
            }
        },
        {
            ...
            click: (e) => {
                ...
                if (testGUIWindow) {
                    testGUIWindow.webContents.send('updateCheckbox', { id: 'scheduleShutdown', checked: e.checked });
                }
            }
        },
        {
        ...
        {
            icon: path.join(basePath, 'image', 'debug.png'),
            label: 'Devtool',
            click: () => {
        ...
        {
            icon: path.join(basePath, 'image', 'info.png'),
            label: '更多信息',
            click: () => {
                dialog.showMessageBox({
                    type: 'info',
